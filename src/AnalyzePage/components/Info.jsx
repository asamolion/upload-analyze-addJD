...
class Info extends Component {
  ...
  handleInfoChange(event) {
        ...
        console.log("checking handleInfoChange", event.target.name, event.target.value);
      ...
      <div>
        <div className="row">
          <div style={colStyle} className="col-md-4">
            <InputField name="Name" onChangeValue={this.handleInfoChange} hintText={formData.Name} labelText="Name" />
          </div>
          <div style={colStyle} className="col-md-4">
            <InputField name="NativeTongue" onChangeValue={this.handleInfoChange} hintText={formData.NativeTongue} labelText="Language" />
          </div>
          <div style={colStyle} className="col-md-4">
            <InputField name="Phone Number" onChangeValue={this.handleInfoChange} hintText={formData.Mobile} labelText="Phone Number" />
          </div>
        </div>
        <div className="row">
         <div style={colStyle} className="col-md-4">
            <InputField name="Email" onChangeValue={this.handleInfoChange} hintText={formData.Email} labelText="Email" />
          </div>
          <div style={colStyle} className="col-md-4">
            <InputField
              name="Location"
          ...
          <div style={colStyle} className="col-md-4">
            <Dropdown onRef={ref => (this.CurrentStatus= ref)} startValue={formData.Status}>
